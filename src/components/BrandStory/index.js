...
import window_bg from "../../images/window.png";
    ...
    <section className="brand-story">
      <div className="container">
        <div className="brand-story__header">
          <h4 className="brand-story__title title--normal">Brand Story</h4>
          <p className="brand-story__desc desc--smaller">
        ...
        <div className="brand-story__content">
          <div className="rectangle">
            <img src={window_bg} alt="window" className="rectangle__img" />
            <div className="rectangle__content">
              <div className="rectangle__header">
                <h4 className="rectangle__title title--smaller extra-bold">
                  What Happened’s Brand story
                </h4>
                <p className="rectangle__desc desc--smaller">
